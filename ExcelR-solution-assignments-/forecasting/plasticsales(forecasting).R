...
tssales<-ts(plasticsales$Sales,frequency = 12, start = c(60))
View(tssales)

# dividing entire data into training and testing data 
train<-tssales[1:48]
test<-tssales[49:60] # Considering only 12 variables monthly wise  of data for testing because data itself is monthly
# seasonal data
...
#9.83
#here the aggriagate errors is only 9.83 so accuracy is huge model is good
############################## STOP HERE ###############################
